            ...
            <div className="flex-1 flex flex-col relative h-[100vh] md:h-full">
                <div className="flex-1 relative min-h-[40vh] md:min-h-0">
                    ...
                    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-4 md:space-y-6 z-20 pointer-events-none pb-2">
                        <button className="pointer-events-auto bg-gradient-to-r from-[var(--accent-orange)] to-[var(--accent-orange-dark)] text-white px-6 md:px-9 py-2 md:py-3 rounded-full font-bold shadow-[0_0_20px_var(--glow-orange)] hover:scale-105 transition-transform duration-200">
                            EXPLORE
                        </button>
                        <div className="pointer-events-auto w-full max-w-[300px] md:max-w-none">
                            <SearchBar />
                        </div>
                    </div>
                </div>
